function [New_Map, Warteschlange, Input_Count]  = input_bahnhofquai_neu(New_Map, i, Warteschlange, Input_Count, free_road, x, steps)
%fügt x-viele Autos in steps-vielen Schritten hinz
